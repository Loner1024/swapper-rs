...
impl FaceRawData {
    pub fn new(tensor: ArrayD<f32>) -> Result<Self> {
        ...
        Ok(Self {
            tensor,
            channels: vec![
                FaceChannelMeta { index: 0,  name: "background", description: "背景" },
                FaceChannelMeta { index: 1,  name: "skin",       description: "皮肤区域" },
                FaceChannelMeta { index: 2,  name: "nose",       description: "鼻子" },
                FaceChannelMeta { index: 3,  name: "eye_g",      description: "眼镜" },
                FaceChannelMeta { index: 4,  name: "l_eye",      description: "左眼" },
                FaceChannelMeta { index: 5,  name: "r_eye",      description: "右眼" },
                FaceChannelMeta { index: 6,  name: "l_brow",     description: "左眉" },
                FaceChannelMeta { index: 7,  name: "r_brow",     description: "右眉" },
                FaceChannelMeta { index: 8,  name: "l_ear",      description: "左耳" },
                FaceChannelMeta { index: 9,  name: "r_ear",      description: "右耳" },
                FaceChannelMeta { index: 10, name: "mouth",      description: "嘴部区域" },
                FaceChannelMeta { index: 11, name: "u_lip",      description: "上唇" },
                FaceChannelMeta { index: 12, name: "l_lip",      description: "下唇" },
                FaceChannelMeta { index: 13, name: "hair",       description: "头发" },
                FaceChannelMeta { index: 14, name: "hat",        description: "帽子" },
                FaceChannelMeta { index: 15, name: "ear_r",      description: "耳环" },
                FaceChannelMeta { index: 16, name: "neck_l",     description: "项链" },
                FaceChannelMeta { index: 17, name: "neck",       description: "颈部" },
                FaceChannelMeta { index: 18, name: "cloth",      description: "衣物" },
            ],
        })
    }
